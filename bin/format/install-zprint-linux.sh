...
curl https://github.com/kkinnear/zprint/releases/download/1.1.1/zprintl-1.1.1 -L --output bin/format/zprint && chmod +x bin/format/zprint
...
LINE='bin/format/git-pre-commit-linux.sh'
